...
"""
Generates demo data for FeedbackMap called congress_gpt3.csv.
It contains real facts about all currently-serving US senators
and representatives, as well as GPT3-synthesized answers to some
...
First download the legislator data at: 
